            ...
            {askForUsername === true ? (
                ...
                <div className={styles.meetVideoContainer}>
                    ...
                    <div className={styles.buttonsConatainer} >
                        ...
                        <Badge badgeContent={!showModal ? newMessages : 0} max={999} color="secondary">
                            <IconButton onClick={handleShowModel} style={{ color: "white" }}>
                                <ChatIcon />
                            </IconButton>
                        </Badge>
